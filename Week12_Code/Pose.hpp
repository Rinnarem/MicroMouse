...
public: 
    ...
    static constexpr float ALPHA = 0.98f; // for complementary filter
    ...
    */
    void snapToWall(float frontMM, float leftMM, float rightMM, bool hasFront, 
        ...
        if (hasLeft && hasRight) {
            ...
            float lateralDist = leftMM + rightMM + ROBOT_WIDTH;
        ...
        if (hasFront) {
            float frontErrorM = (frontMM - FRONT_CENTER_OFFSET_MM) / 1000.0f;
